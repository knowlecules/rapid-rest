...
module.exports = function () {
    ...
    */
    var rest = function (route, isCaseInsensitive) {
        ...
        return {
            add : function (urlPath, isCaseInsensitive) {
                ...
                var urlDef = url.parse(urlPath, true),
                    ...
                    patternRE = new RegExp(urlMatch, isCaseInsensitive ? "i" : ""),
                    paramKeys = (urlPath.indexOf("/:") > -1) ? urlDef.pathname.replace(/(\/[^:][^\/]+)/g, '').substr(2).split("/:") : [],
